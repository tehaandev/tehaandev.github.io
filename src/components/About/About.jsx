    ...
    <main className="container about-content">
      <div className="sub-container">
        ...
        <p>
          ...
          <span className="text-tertiary">React, Vite, Angular, Ionic</span> etc. I am also skilled
          in a variety of other programming languages and technologies, including{" "}
          <span className="text-tertiary">C#, Java, Node.js, PHP, Python, SQL</span>, and more. I am
          a quick learner and I am always eager to take on new challenges.
        </p>
        <p>
          In addition to my technical skills, I am also a team player and I have excellent
          communication and interpersonal skills. I am confident that I would be a valuable asset to
          any team.
        </p>
      </div>
      <div className="sub-container">
        ...
        <div className="two-card-layout">
          ...
          <div className="about-layout-card-right">
            ...
            <ul>
              <li>
                Worked in a team responsible for developing and maintaining custom mobile and web
                apps for high-end clientele using Angular and Ionic Framework.
              </li>
              <li>Gained experience in conducting dev testing by running multiple test cases.</li>
            </ul>
          </div>
        </div>
      </div>
